...
| `NEXT_PUBLIC_EMAILJS_TEMPLATE_ID` | Template do formulário de contato |
...
| `EMAILJS_TEMPLATE_ID` ou `NEXT_PUBLIC_EMAILJS_TEMPLATE_ID` | ID do template de contato |
| `EMAILJS_SATISFACTION_TEMPLATE_ID` ou `NEXT_PUBLIC_EMAILJS_SATISFACTION_TEMPLATE_ID` | ID do template de satisfação |
