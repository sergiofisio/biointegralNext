export default function ModalFooter({ children }: any) {
    return <div *ngIf="showModal"
    className="fixed right-0 top-0 z-10 w-full h-full flex items-center justify-center bg-blue bg-opacity-50">
