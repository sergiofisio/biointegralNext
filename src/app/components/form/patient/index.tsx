    ...
    async function getInfoForm() {
      ...
      setForm((currentForm) => ({
        ...
        step1: {
          ...
          birth: { ...currentForm.step1.birth, value: formItens[3][1] || "" },
          gender: { ...currentForm.step1.gender, value: formItens[4][1] || "" },
          religion: {
          ...
          emotion: {
            ...
            value: (formItens[9][1] as string[] | null) || [],
            especifique: {
          ...
          adress: {
            ...currentForm.step1.adress,
            street: {
              ...currentForm.step1.adress.street,
            ...
            neighborhood: {
              ...currentForm.step1.adress.neighborhood,
              value: formItens[19][1] || "",
            },
            city: {
              ...currentForm.step1.adress.city,
              value: formItens[20][1] || "",
            },
            state: {
              ...currentForm.step1.adress.state,
              value: formItens[21][1] || "",
            },
            zipcode: {
              ...currentForm.step1.adress.zipcode,
        ...
        step2: {
          ...
          simptomes: {
            ...
            value: (formItens[31][1] as string[] | null) || [],
          },
        },
        step3: currentForm.step3.map((question, key) => {
          return { ...question, value: formItens[key + 32][1] || "" };
        }),
        step4: {
          ...currentForm.step4,
          parentsAlive: {
            ...currentForm.step4.parentsAlive,
            value: formItens[92][1] || "",
            relationship: {
              ...currentForm.step4.parentsAlive.relationship,
              value: formItens[93][1] || "",
            },
            description: {
